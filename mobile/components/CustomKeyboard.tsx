        ...
        return (
            <View>
                ...
                <View style={{flexDirection: "row"}}>
                    ...
                    <View style={styles.button}>
                        <TouchableOpacity onPress={this.onPressMultiply}>
                            <Text style={styles.buttonLabel}>
                                *
                            </Text>
                        </TouchableOpacity>
                    ...
                    <View style={styles.button}>
                        <TouchableOpacity onPress={this.onPressSubtract}>
                            <Text style={styles.buttonLabel}>
                                -
                            </Text>
                        </TouchableOpacity>
                    ...
                    <View style={styles.button}>
                        <TouchableOpacity onPress={this.onPressDivide}>
                            <Text style={styles.buttonLabel}>
                                /
                            </Text>
                        </TouchableOpacity>
